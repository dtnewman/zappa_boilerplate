...
class Development(Config):
    ...
    ENV = 'dev'
    DEBUG = True
    SQLALCHEMY_DATABASE_URI = os.environ.get("DATABASE_URL") or '<DEVOLOPMENT DATABASE HERE>' # TODO: Change me
    FLASKS3_ACTIVE = True
    FLASKS3_DEBUG = True
...
class Production(Config):
    ...
    ENV = 'prod'
    DEBUG = False
    SQLALCHEMY_DATABASE_URI = os.environ.get("DATABASE_URL") or '<PRODUCTION DATABASE HERE>' # TODO: Change me
    DEBUG_TB_ENABLED = False  # Disable Debug toolbar
